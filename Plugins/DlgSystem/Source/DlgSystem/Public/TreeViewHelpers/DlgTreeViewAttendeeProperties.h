...
/** Structure that holds the common properties of a Attendee (where it appears and stuff like this) in the STreeView. */
template <class VariablePropertyType>
class FDlgTreeViewAttendeeProperties
{
...
public:
	FDlgTreeViewAttendeeProperties(const TSet<TWeakObjectPtr<const UDlgDialogue>>& InDialogues) : Dialogues(InDialogues) {}
	FDlgTreeViewAttendeeProperties(const TSet<TWeakObjectPtr<const UDlgDialogue>>&& InDialogues) : Dialogues(InDialogues) {}
	...
	// Add Dialogue that containt this attendee.
	...
	/** Does this attendee has any dialogue values of the basic type */
	bool HasDialogueValues() const
	{
		return Integers.Num() > 0 || Floats.Num() > 0 || Bools.Num() > 0 || FNames.Num() > 0;
	}

	/** Does this attendee has any variables that belong to the UClass of the attendee */
...
protected:
	...
	)
	{
		...
		{
			// Variable does not exist for attendee, create it
...
protected:
	/**
	 * Dialogues that contain this attendee
	...
	/**
	 * Events that belong to this attendee
	 * Key: Event Name
	...
	/**
	 * Custom Events that belong to this attendee
	...
	/**
	 * Conditions that belong to this attendee
	 * Key: Condition Name
	...
	/**
	 * Int variables that belong to this attendee
	...
	/**
	 * Float variables that belong to this attendee
	...
	/**
	 * Bool variables that belong to this attendee
	...
	/**
	 * FNames variables that belong to this attendee
	...
	/**
	 * Int variables that belong to the UClass of this attendee
	 * Key: Int Variable Name
	 * Value: The properties of this int variable
	 */
	...
	/**
	 * Float variables that belong to the UClass of this attendee
	 * Key: Float Variable Name
	 * Value: The properties of this float variable
	 */
	...
	/**
	 * Bool variables that belong to the UClass of this attendee
	 * Key: Bool Variable Name
	 * Value: The properties of this bool variable
	 */
	...
	/**
	 * FNames variables that belong to the UClass of this attendee
	 * Key: FName Variable Name
	 * Value: The properties of this FName variable
	 */
	...
	/**
	* FText variables that belong to the UClass of this attendee
