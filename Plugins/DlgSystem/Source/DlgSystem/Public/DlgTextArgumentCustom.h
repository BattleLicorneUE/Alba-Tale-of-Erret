...
public:
	...
	FText GetText(const UDlgContext* Context, const UObject* Attendee, const FString& DisplayStringParam);
	virtual FText GetText_Implementation(const UDlgContext* Context, const UObject* Attendee, const FString& DisplayStringParam)
	{
