...
public:
	...
	// If true, AttendeesClasses from each Dialogue will be set to the first Class that matches the AttendeeName
	// NOTE: This only sets the default for attendee names that have only ONE attendee class
	// NOTE: This does not work for the None Attendee Name
	UPROPERTY(Category = "Dialogue", Config, EditAnywhere)
	bool bAutoSetDefaultAttendeeClasses = true;
