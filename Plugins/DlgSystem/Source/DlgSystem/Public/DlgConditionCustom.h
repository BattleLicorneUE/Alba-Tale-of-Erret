...
public:
	...
	bool IsConditionMet(const UDlgContext* Context, const UObject* Attendee);
	virtual bool IsConditionMet_Implementation(const UDlgContext* Context, const UObject* Attendee)
	{
		return false;
	}
};
