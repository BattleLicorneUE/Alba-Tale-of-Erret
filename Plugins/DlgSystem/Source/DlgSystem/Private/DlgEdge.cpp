...
void FDlgEdge::RebuildConstructedText(const UDlgContext& Context, FName FallbackAttendeeName)
{
	...
	{
		OrderedArguments.Add(DlgArgument.DisplayString, DlgArgument.ConstructFormatArgumentValue(Context, FallbackAttendeeName));
	}
