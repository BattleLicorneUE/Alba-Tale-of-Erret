...
//////////////////////////////////////////////////////////////////////////
// A filter that search for blueprints that have implemented the Dialogue Attendee
class FFrontendFilter_DialogueAttendees : public FFrontendFilter
{
public:
	FFrontendFilter_DialogueAttendees(const TSharedPtr<FFrontendFilterCategory>& InCategory)
		: FFrontendFilter(InCategory)
	{
	}
	...
	FString GetName() const override
	{
		return TEXT("Dialogue Attendee Filter");
	}
	FText GetDisplayName() const override
	{
		return LOCTEXT("FilterDialogueAttendees_Name", "Dialogue Attendee");
	}
	FText GetToolTipText() const override
	{
		return LOCTEXT("FilterDialogueAttendees_ToolTip", "Search for any Blueprints that implement the Dialogue Attendee Interface");
	}
	...
	bool PassesFilter(FAssetFilterType InItem) const override
	{
		...
		{
			return UDlgManager::DoesObjectImplementDialogueAttendeeInterface(Object);
		}
#else
...
) const
{
	...
	InOutFilterList.Add(MakeShared<FFrontendFilter_DialogueAttendees>(DialogueCategory));
