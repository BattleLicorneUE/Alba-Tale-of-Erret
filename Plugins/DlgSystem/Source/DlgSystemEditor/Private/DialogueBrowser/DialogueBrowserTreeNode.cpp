...
FName FDialogueBrowserTreeNode::GetParentAttendeeName() const
{
	if (Parent.IsValid())
	{
		return Parent.Pin()->GetParentAttendeeName();
	}
...
FString FDialogueBrowserTreeNode::ToString() const
{
	...
	//AddFNameToOutput("AttendeeName", AttendeeName);
...
FDialogueBrowserTreeAttendeeNode::FDialogueBrowserTreeAttendeeNode(
	const FText& InDisplayText,
	const TSharedPtr<FDialogueBrowserTreeNode>& InParent,
	FName InAttendeeName
) : Super(InDisplayText, InParent), AttendeeName(InAttendeeName)
{
}

FName FDialogueBrowserTreeAttendeeNode::GetParentAttendeeName() const
{
	...
	return Super::GetParentAttendeeName();
}
...
FDialogueBrowserTreeCategoryAttendeeNode::FDialogueBrowserTreeCategoryAttendeeNode(
	const FText& InDisplayText,
	const TSharedPtr<FDialogueBrowserTreeNode>& InParent,
	FName InAttendeeName
) : Super(InDisplayText, InParent, InAttendeeName)
{
	CategoryType = EDialogueTreeNodeCategoryType::Attendee;
}
