...
protected:
	...
	// Makes Attendee categories.
	TArray<TSharedPtr<FDialogueBrowserTreeNode>> MakeAttendeeCategoriesChildren(
...
protected:
	...
	// Tree view for showing all attendees, etc.
	TSharedPtr<STreeView<TSharedPtr<FDialogueBrowserTreeNode>>> AttendeesTreeView;

	/**
	 * Used for fast lookup of each attendees
	 * Key: Attendee Name
	 * Value: attendee properties
	 */
	TMap<FName, TSharedPtr<FDialogueBrowserTreeAttendeeProperties>> AttendeesProperties;
