	...
	FDetailWidgetRow& HeaderRow, IPropertyTypeCustomizationUtils& StructCustomizationUtils)
{
	...
	AttendeeNamePropertyHandle = StructPropertyHandle->GetChildHandle(GET_MEMBER_NAME_CHECKED(FDlgTextArgument, AttendeeName));
	...
	switch (ArgumentType)
	{
		case EDlgTextArgumentType::DialogueInt:
			if (bCurrentOnly && Dialogue)
			{
				...
				Dialogue->GetIntNames(AttendeeName, SuggestionsSet);
		...
		case EDlgTextArgumentType::DialogueFloat:
			...
			{
				TSet<FName> SuggestionsSet;
				Dialogue->GetFloatNames(AttendeeName, SuggestionsSet);
				Suggestions = SuggestionsSet.Array();
			}
			else
			{
