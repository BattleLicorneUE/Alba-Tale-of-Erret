...
{
	return NSLOCTEXT("K2Node", "SwitchDialogueCallbackEvent_ToolTip", "Lists all available events from all dialogues for the owner based on IDlgDialogAttendee::GetAttendeeName() function call");
}
...
{
	return NSLOCTEXT("K2Node", "SwitchDialogueCallbackCondition_ToolTip", "Lists all available conditions from all dialogues for the owner based on IDlgDialogAttendee::GetAttendeeName() function call");
}
...
{
	return NSLOCTEXT("K2Node", "SwitchDialogueFloatValue_ToolTip", "Lists all available float value name from all dialogues for the owner based on IDlgDialogAttendee::GetAttendeeName() function call");
}
...
{
	return NSLOCTEXT("K2Node", "SwitchDialogueIntValue_ToolTip", "Lists all available Integer value names from all dialogues for the owner based on IDlgDialogAttendee::GetAttendeeName() function call");
}
...
{
	return NSLOCTEXT("K2Node", "SwitchDialogueBoolValue_ToolTip", "Lists all available Bool value names from all dialogues for the owner based on IDlgDialogAttendee::GetAttendeeName() function call");
}
...
{
	return NSLOCTEXT("K2Node", "SwitchDialogueNameValue_ToolTip", "Lists all available Name value names from all dialogues for the owner based on IDlgDialogAttendee::GetAttendeeName() function call");
}
