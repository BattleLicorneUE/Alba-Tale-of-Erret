...
bool UDialogueK2Node_SwitchDialogueCallback::RefreshPinNames()
{
	...
	switch (CallbackType)
	{
		case EDlgDialogueCallback::Event:
			UDlgManager::GetAllDialoguesEventNames(AttendeeName, NewPinNames);
			break;

		case EDlgDialogueCallback::Condition:
			UDlgManager::GetAllDialoguesConditionNames(AttendeeName, NewPinNames);
			break;
		...
		case EDlgDialogueCallback::BoolValue:
			UDlgManager::GetAllDialoguesBoolNames(AttendeeName, NewPinNames);
			break;
